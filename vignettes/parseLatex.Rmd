...
using a LaTeX package that uses non-standard rules, you can 
use those.

However, subject to the limitation that the code only uses one
set of
...
```{r echo = FALSE}
tags <- data.frame(Tag = c("BLOCK", "COMMENT", "DISPLAYMATH", "ENVIRONMENT", "MACRO", "MATH", "SPECIAL", "TEXT", "VERB"),
        Description = c(
...
```
- The `tools::parseLatex()` parser does not have the `SPECIAL` tag;
